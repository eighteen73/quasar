...
namespace Quasar\ThirdParty\WooCommerce;
...
class Account implements Bootable {
	...
	public function login_intro_text(): void {
		echo '<p>' . esc_html__( 'Please enter your email & password to login', 'quasar' ) . '</p>';
	}
	...
	public function register_intro_text(): void {
		echo '<p>' . esc_html__( 'Creating an account is easy and only takes a few minutes', 'quasar' ) . '</p>';
	}
