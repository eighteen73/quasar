...
class Setup implements Bootable {
	...
	public function menus(): void {
		...
		register_nav_menus(
			[
				'primary'  => esc_html_x( 'Primary', 'nav menu location', 'quasar' ),
				'footer-1' => esc_html_x( 'Footer 1', 'nav menu location', 'quasar' ),
				'footer-2' => esc_html_x( 'Footer 2', 'nav menu location', 'quasar' ),
				'legal'    => esc_html_x( 'Legal', 'nav menu location', 'quasar' ),
			]
		);
	}
	...
	public function image_size_names( array $sizes ): array {
		...
		$custom_sizes = [
			'extra-large' => __( 'Extra Large', 'quasar' ),
		];
